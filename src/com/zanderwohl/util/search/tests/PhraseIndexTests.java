...
public class PhraseIndexTests extends TestCase {
    ...
    public static Collection searchSets(){
        return Arrays.asList(new Object[][] {
                {"Brave New World", new ArrayList<String>(Arrays.asList("Brave New World", "Brave New World 2", "Brave Old World", "Brave Little Toaster")), REASONS.EXACT_MATCH},
                {"Brave Old World", new ArrayList<String>(Arrays.asList("Brave Old World", "Brave New World", "Brave New World 2", "Brave Little Toaster")), REASONS.EXACT_MATCH},
                {"Foundation", new ArrayList<String>(Arrays.asList("Foundation", "Foundation and Empire", "Second Foundation")), REASONS.SINGLE_WORD},
                {"Foundation Four", new ArrayList<String>(Arrays.asList("Foundation", "Foundation and Empire", "Second Foundation")), REASONS.EXTRA_WORDS},
                {"Origin Into the Species", new ArrayList<String>(Arrays.asList("On the Origin of the Species by Means of Natural Selection, or the Preservation of Favoured Races in the Struggle for Life")), REASONS.WRONG_PREPOSITIONS},
        });
    }
